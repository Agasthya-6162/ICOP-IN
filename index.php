...
?>
            ...
            <div class="ticker-content">
                <marquee behavior="scroll" direction="left" scrollamount="5">
                    <?php if (count($tickerUpdates) > 0): ?>
                        <?php foreach ($tickerUpdates as $update): ?>
                            <span class="ticker-item">
                                ...
                                <?php if (!empty($update['link_url'])): ?>
                                    <a href="<?php echo htmlspecialchars($update['link_url']); ?>" style="color: inherit; text-decoration: none;">
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <span class="ticker-item"><span class="new-badge">NEW</span> Admissions Open for Academic Year 2026-27 - Apply Now!</span>
                        <span class="ticker-separator">|</span>
    ...
    <main id="main-content">
                ...
                <?php if (count($banners) > 0): ?>
                    <?php foreach ($banners as $index => $banner): ?>
                        <div class="slide <?php echo $index === 0 ? 'active' : ''; ?>">
                            <img src="<?php echo htmlspecialchars(SITE_URL . '/' . $banner['image_path']); ?>" alt="<?php echo htmlspecialchars($banner['title']); ?>">
            ...
            <div class="container">
                ...
                <div class="message-content">
                    ...
                    <div class="message-text">
                        ...
                        <a href="about.php#secretary" class="read-more-btn">Read Full Message <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Principal's Message -->
        <section class="principal-message" style="background-color: #f8f9fa;">
            <div class="container">
                <div class="section-header">
                ...
                <div class="news-events-grid">
                                ...
                                <?php foreach ($latestNews as $news): ?>
                                    <div class="news-item">
                                        ...
                                        <div class="news-content">
                                            <h4><a href="notices.php?id=<?php echo $news['id']; ?>"><?php echo htmlspecialchars($news['title']); ?></a></h4>
                    ...
                    <div class="events-section">
                        <div class="section-header">
                            ...
                            <a href="notices.php?category=Event" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                        </div>
                                ...
                                <?php foreach ($upcomingEvents as $event): ?>
                                    <div class="event-card">
                                        <div class="event-date">
                                            <i class="far fa-calendar-alt"></i> <?php echo date('d M Y', strtotime($event['publish_date'])); ?>
                                        </div>
                                        <h3><a href="notices.php?id=<?php echo $event['id']; ?>"><?php echo htmlspecialchars($event['title']); ?></a></h3>
                                        <a href="notices.php?id=<?php echo $event['id']; ?>" class="event-link">Details <i class="fas fa-chevron-right"></i></a>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
