                ...
                <div class="form-step active" id="step1">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" id="mobile" pattern="[0-9]{10}" required placeholder="10 Digit Mobile No">
                        </div>
                        <div class="form-group">
        ...
        <div class="print-application" id="printableForm">
            <div class="application-header"
                ...
                <div style="flex: 1; text-align: center;">
                    ...
                    <h2 style="color: #666; font-size: 14px; margin-bottom: 5px; font-weight: normal;">Vishnupuri Nanded
                        431606</h2>
                    <p style="margin: 5px 0; font-size: 12px;">Affiliated to Swami Ramanand Teerth Marathwada University
                        Nanded | Hospital Tie-up with Dr. Shankarrao Chavan Medical College And Hospital |
            ...
            <div class="application-details">
                ...
                <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
                    <p style="font-size: 0.85rem; color: #666;">
                        Indira College of Pharmacy | Vishnupuri, Nanded - 431606 | Phone: +91 9673421313 |
                        Email: admissions@sssicop.org
                    </p>
