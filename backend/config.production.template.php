 ...
 * 
 * IMPORTANT: Use this file for production deployment
...
// ============================================
// Update these with your hosting details

define('DB_HOST', 'localhost');           // Your database server
define('DB_NAME', 'icop_website');        // Your database name
define('DB_USER', 'icop_user');           // Create dedicated DB user (NOT root!)
...
define('SITE_URL', 'https://yourdomain.com');  // ⚠️ UPDATE WITH YOUR URL
