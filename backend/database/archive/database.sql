-- ============================================
-- ICOP Website Complete Database (Production Ready)
...
-- ============================================
-- 14. LATEST UPDATES TABLE (Ticker)
-- ============================================
...
-- Sample Updates Data
INSERT INTO latest_updates (content, link_url, display_order, is_active) VALUES
('Admissions Open for 2026-27 Academic Year - Apply Online Now!', 'apply-online-enhanced.html', 1, 1),
('Result of B.Pharm Sem I declared. Check Results section.', 'results.php', 2, 1),
('Guest Lecture on "Future of Pharma Industry" by Dr. Patil on Jan 30th', 'notices.php', 3, 1);
